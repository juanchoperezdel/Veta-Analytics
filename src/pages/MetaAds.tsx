...
export default function MetaAds() {
  ...
  if (!data?.metaAds) return <div className="p-8 text-slate-500">No hay datos disponibles</div>;

  const { kpis, campaigns } = data.metaAds;
  ...
  return (
    <div className="py-12 max-w-7xl mx-auto space-y-8 relative z-10">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <SmallKpiCard title="Compras" value={formatNumber(kpis.purchases!.value)} delta={kpis.purchases!.delta} />
